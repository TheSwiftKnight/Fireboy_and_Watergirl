...
namespace Engine {
	...
	void Sprite::TDraw(int sX,int sY) const {
		al_draw_scaled_bitmap(bmp.get(),sX*(GetBitmapWidth()/6),0,GetBitmapWidth()/6,GetBitmapHeight(),Position.x,Position.y,GetBitmapWidth()/6,GetBitmapHeight(),0);
	}
